      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-10 py-16">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="bg-white/10 backdrop-blur-sm w-10 h-10 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-[#8E0E00] hover:to-[#FF6B00] transition-all duration-300"
                >
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm">© {currentYear} AdSpark. All rights reserved.</p>
